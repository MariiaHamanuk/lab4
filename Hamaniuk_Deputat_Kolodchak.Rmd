...
(d) Suggest a way to test whether the study time is significant in
  ...
  $t = \frac{5.68875}{0.2042338} = \mathbf{27.85411}$
    ...
    Under $H_0$, this statistic follows a Student distr. with
    n - (num of predictors) - 1degrees of freedom so 98 because one
    predictor is 0 and error in our equation is obviously not a
    predictor.
